       ...
       <li class="dropdown-item user-details">
        <a href="javaScript:void();">
           <div class="media">
            ...
            <h6 class="mt-2 user-title"><?php echo $row['nombre'] ?></h6>
...
<div class="clearfix"></div>
    ...
    <div class="container-fluid">
      ...
      <div class="row mt-3">
        <div class="col-lg-4">
           <div class="card profile-card-2">
            <div class="card-img-block">
                <img class="img-fluid" src="https://www.gacetamexicana.com/wp-content/uploads/2015/03/Barack-Obama-800x500.jpg" alt="Card image cap">
            </div>
            <div class="card-body pt-5">
                <img src="https://twimgs.com/infoweek/graphics_library/175x175/obama_champion.jpg" alt="profile-image" class="profile">
            ...
            <div class="card-body border-top border-light">
                 <div class="media align-items-center">
                   <div>
                       <img src="assets/images/timeline/Gold.png" class="skill-img" alt="skill img">
                   </div>
                     <div class="media-body text-left ml-3">
                       <div class="progress-wrapper">
                         <p>Gold Plan Duration <span class="float-right">24 Months - 50%</span></p>
       ...
       while($row=mysqli_fetch_assoc($resultado)) { ?>
                    <form action="../procesar.php" method="post" class="form-signin" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <input class="form-control" type="text" value="<?php echo $row['city'] ?>" name="city" placeholder="City">
                            </div>
                            <div class="col-lg-3">
                                <input class="form-control" type="text" value=""  name="state" placeholder="State">
                            </div>
                        </div>
  ...
  <!-- Custom scripts -->
  <script src="assets/js/app-script.js"> <?php } mysqli_free_result($resultado); ?> </script>
